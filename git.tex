...
correct and you need to write new code to fix the conflict. 
...
system. Branches allow programmer to fulfill two needs: 

\begin{description}
\item[Experiments: ] Sometimes you want to add a new feature to your
  program, but you do not want to break your program. You can develop
  the experimental functionality in a separated branch while you keep
  the main program in \emph{master}.
\item[External collaborators: ] When other programmers 
\end{description}
