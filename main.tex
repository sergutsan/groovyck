...
%
% \item Optional? Basics of regular expressions
...
%      - introduce them to JavaDocs: constructors, methods, deprecated
...
%            list (a growing/decreasing array, using a Node class that
%            contains data and points to another Node) 
% \item day 7: More on data structures: queues and stacks, iterators,
%            JavaDoc: document inputs, output, and rationale 
% \item day 8: More on data structures: trees and maps; binary and
%      non-binary trees, for-each loops
%         memory allocation, gargage collection, memory leaks (profiling?)
...
%   hierarchies, upcasting/downcasting), polymorphism,
