...
% Day 3: getting up to speed, but not quite
...
%       the week after.
% \item day 6: Real java: all files are classes, the main method,
%            System.out.println(); bye, bye, Groovy scripts,
%            introduce pointers and use it for creating a linked
%            list (a growing array) 
% \item day 7: More on data structures: queues and stacks, iterators,
%            JavaDoc: document inputs, output, and rationale 
% \item day 8: More on data structures: trees and maps; for-each loops
