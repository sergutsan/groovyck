...
%       trees are presented
%   - PT should go to Xmas knowing how to use the Java Collections
%       Library 
...
%   D9: trees,
%   D10: testing, introducing annotations
%   D11: TDD, final, more annotations, write javadoc
%   D12: inheritance
%   D13: polymorphism (and the collections library)
%   D14: Exception handling
%   D15: I/O
%   D16: concurrency 1: basics
%   D17: concurrency 2: java.concurrent
%   D18: concurrency 3: fork/join and more practice
%   D19: network 1
%   D20: network 2
%   D21: work in the lab
%   D22: work in the lab
