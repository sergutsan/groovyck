...
\begin{figure}[bthp]
  \centering
  \includegraphics[width=\textwidth]{gfx/lists-init}  
...
\begin{figure}[bthp]
  \centering
  \includegraphics[width=\textwidth]{gfx/lists-remove-1}    
  \caption{Deletion of elements in a linked list, step one: finding
    ...
    former patient to the following patient.(For simplicity, only the
    nextPatient field is shown in the Patient objects.)}
...
\begin{figure}[bthp]
  ...
  \caption{Deletion of elements in a linked list, step two: linking
    the former patient to the following patient. (For simplicity, only
    the nextPatient field is shown in the Patient objects.)}
...
process called \emph{garbage collection}. The memory freed in this
